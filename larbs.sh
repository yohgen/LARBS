...
# With modifications
# by Jørgen Tau <jorgentau@gmail.com>
# License: WTFPLv2
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/yohgen/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/yohgen/LARBS/master/progs.csv"
